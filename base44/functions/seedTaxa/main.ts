...
const SAMPLE_TAXA = [
  ...
  // ... (abbreviated for response; in actual use include full SAMPLE_TAXA from local file)
  // Include all the comprehensive psychoactive mushrooms and plants from the current local seedTaxa
];
